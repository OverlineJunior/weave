...
\begin{figure}[H]
	...
	\fonte{\textcite{craftinginterpreters}.}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
    	...
    	\fonte{Elaboração própria com base em \textcite{craftinginterpreters}.}
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[height=0.28\textheight]{interpretacao}
