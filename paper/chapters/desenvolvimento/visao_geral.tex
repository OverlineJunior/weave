...
\begin{quadro}[h]
	...
	\caption{Terminologia utilizada para se referir às fases do interpretador e seus componentes.}
	{
		\begin{tabular}{|l|l|}
			...
			Análise Léxica    & \textit{Lexer}       \\ \hline
			Análise Sintática & \textit{Parser}      \\ \hline
