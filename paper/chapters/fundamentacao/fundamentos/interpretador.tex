...
Em termos de arquitetura de software, este trajeto pela montanha da \autoref{fig:mapa_interpretador} divide o interpretador em duas grandes etapas: o \textit{front-end} e o \textit{back-end}. O \textit{front-end} é responsável pela análise do código fonte, englobando as fases léxica e sintática para analisar a estrutura do programa. Já o \textit{back-end} encarrega-se da execução propriamente dita \cite{craftinginterpreters}. Neste trabalho, será implementado apenas o \textit{front-end}, com o \textit{back-end} sendo fundamentado teoricamente.
