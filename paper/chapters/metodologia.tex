...
\begin{itemize}
    \item Não serão abordados aspectos relacionados ao desempenho da linguagem, como tempo de execução e uso de memória, devido à complexidade adicional envolvida na análise desses aspectos;
    ...
    \item A fase de interpretação da linguagem será abordada de forma teórica, sem sua implementação. Essa decisão foi tomada devido à limitação de tempo disponível para implementar a fase.
\end{itemize}
...
\section{Síntese do Delineamento Metodológico}

O \autoref{qad:delineamento_metodologico} apresenta uma síntese do delineamento metodológico adotado, relacionando os objetivos específicos deste trabalho com as fontes de dados, técnicas de coleta e técnicas de análise correspondentes.
...
\begin{quadro}[h]
    ...
    \footnotesize
	{
		\begin{tabular}{|l|l|l|l|l|l|}
			\hline
            \multicolumn{2}{|l|}{\textbf{Objetivos}} & \textbf{Como será atingido} & \textbf{Fonte de dados} & \textbf{Técnica de coleta} & \textbf{Técnica de análise} \\ \hline
			foo & bar & baz & qux & quux & corge \\ \hline
            foo & bar & baz & qux & quux & corge \\ \hline
            foo & bar & baz & qux & quux & corge \\ \hline
            foo & bar & baz & qux & quux & corge \\ \hline
		\end{tabular}
	...
	\label{qad:delineamento_metodologico}
\end{quadro}
