...
Como desenvolver um protótipo de interpretador para uma linguagem de programação orientada ao ECS — com as fases de análise léxica e sintática implementadas e a fase de interpretação especificada conceitualmente — de modo que sirva de base para trabalhos futuros?
