...
Sabendo que o padrão ECS tem o seu lugar no mercado \cite{ecsiotbrokers, ecscomputergraphics} e que há uma lacuna na exploração de abstrações do padrão por meio de linguagens de programação, este trabalho propõe investigar a implementação do \textit{front-end} do interpretador para uma linguagem orientada ao ECS, além de fundamentar a fase de interpretação.

Com o \textit{front-end} implementado e a fase de interpretação fundamentada, espera-se que este trabalho sirva como base para futuras pesquisas e desenvolvimentos na área acadêmica, incentivando a exploração de novas formas de abstração do padrão ECS por meio de linguagens de programação.
