...
Implementar o \textit{front-end} e descrever teoricamente a fase de interpretação de uma linguagem orientada ao ECS, para investigar a viabilidade e os desafios de integração entre a teoria de compiladores e o padrão ECS.
